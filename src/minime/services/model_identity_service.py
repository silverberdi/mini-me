...
class CanonicalModelRegistry:
    ...
    def _initialize_canonical_registry(self) -> None:
        ...
        # Qwen family
        qwen_coder_32b = CanonicalModelIdentity(
            "openrouter", "qwen", "qwen-2.5-coder-32b", "qwen:qwen-2.5-coder-32b"
        )
        qwen_coder_3 = CanonicalModelIdentity(
        ...
        gpt_4o_mini = CanonicalModelIdentity(
        ...
        # Meta Llama family
        llama_70b = CanonicalModelIdentity(
            "openrouter", "llama", "llama-3.3-70b", "meta-llama:llama-3.3-70b"
        )
        llama_70b_31 = CanonicalModelIdentity(
            "openrouter", "llama", "llama-3.1-70b", "meta-llama:llama-3.1-70b"
        )
        llama_405b = CanonicalModelIdentity(
            "openrouter", "llama", "llama-3.1-405b", "meta-llama:llama-3.1-405b"
        )
        ...
        # Mistral family
        mistral_large = CanonicalModelIdentity(
            "openrouter", "mistral", "mistral-large", "mistralai:mistral-large"
        )
        codestral = CanonicalModelIdentity(
            "openrouter", "mistral", "codestral", "mistralai:codestral"
        )
        ...
        # DeepSeek family
        deepseek_chat = CanonicalModelIdentity(
            "openrouter", "deepseek", "deepseek-chat", "deepseek:deepseek-chat"
        )
        deepseek_coder = CanonicalModelIdentity(
        ...
        gemini_pro = CanonicalModelIdentity(
            "openrouter", "google", "gemini-1.5-pro", "google:gemini-1.5-pro"
        )
        gemini_flash = CanonicalModelIdentity(
            "openrouter", "google", "gemini-1.5-flash", "google:gemini-1.5-flash"
        )
