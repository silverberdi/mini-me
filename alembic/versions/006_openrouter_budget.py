...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("additional_cost_per_request", sa.Numeric(10, 6), nullable=False, server_default="0"),
        sa.Column("currency", sa.String(length=3), nullable=False, server_default="USD"),
    ...
    op.create_table(
        ...
        sa.Column("pricing_snapshot_id", sa.String(length=128), sa.ForeignKey("openrouter_pricing_snapshots.id", ondelete="RESTRICT"), nullable=False),
    ...
    op.create_table(
        "budget_ledger",
        sa.Column("id", sa.String(length=36), primary_key=True),
        sa.Column("reservation_id", sa.String(length=36), sa.ForeignKey("budget_reservations.id", ondelete="SET NULL"), nullable=True),
        sa.Column("project_id", sa.String(length=64), sa.ForeignKey("projects.id", ondelete="CASCADE"), nullable=False),
        sa.Column("job_id", sa.String(length=64), sa.ForeignKey("jobs.id", ondelete="CASCADE"), nullable=False),
        sa.Column("change_id", sa.String(length=128), nullable=False),
    ...
    op.create_index("ix_budget_reservations_project_status", "budget_reservations", ["project_id", "status"])
    op.create_index("ix_budget_reservations_created_at", "budget_reservations", ["created_at"])
    op.create_index("ix_budget_ledger_project_created", "budget_ledger", ["project_id", "created_at"])
