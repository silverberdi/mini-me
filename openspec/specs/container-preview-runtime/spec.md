...
Provides container preview runtime orchestration for mini me, building isolated container images from exact candidate worktrees, allocating safe non-conflicting host ports, managing preview container lifecycles, probing HTTP health endpoints, and performing idempotent teardown and orphan container recovery without touching production state or foreign containers.
